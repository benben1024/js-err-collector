/**
 * Created by weipeng on 2017/5/22.
 */
...
;(function(){
    ...
    if (window.jsErrCollector){

        return window.jsErrCollector
    };
     ...
     * 核心代码区
     **/
    var jsErrCollector=function(params){
    ...
    window.jsErrCollector=jsErrCollector;

})();

/*===========================
 jsErrCollector AMD Export
 ===========================*/
if (typeof(module) !== 'undefined'){
    module.exports = window.jsErrCollector;
}
